...
def test_authorize():
    ...
    expr = pt.Seq(pt.Assert(auth_only(pt.Txn.sender()), comment="unauthorized"), pt.Approve())
    ...
    expr = pt.Seq(pt.Assert(auth_holds_token(pt.Txn.sender()), comment="unauthorized"), pt.Approve())
    ...
    expr = pt.Seq(pt.Assert(auth_opted_in(pt.Txn.sender()), comment="unauthorized"), pt.Approve())
